 ...
 */
package com.anxin.cloud.demo.kafka.task;
...
import com.anxin.cloud.demo.kafka.service.inter.KafkaService;
    ...
    public void taskStart() {
      /*  EmailDto email = new EmailDto();
       ...
       /* email.setParaMap(paraMap);
        ...
        kafkaService.sendUserInfo("test_replicated_topic", JSON.toJSONString(paraMap));
        //kafkaService.sendUserInfo("test_replicated_topic", String.valueOf(System.currentTimeMillis()));
        System.out.println("=============================:email");
    }
